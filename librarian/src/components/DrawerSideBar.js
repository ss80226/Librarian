    ...
    render() {
      ...
      return (
        <Container style={styles.drawer}>
            ...
            <Button block transparent style={styles.item} onPress={() => navigate('Search')}>
            ...
            <Button block transparent style={styles.item} onPress={() => navigate('History')}>
                <Icon name='tag-multiple' style={styles.icon} />
                <Text style={styles.text}>Forecast</Text>
            </Button>
            <Button block transparent style={styles.item} onPress={() => navigate('Result')}>
                <Icon name='tag-multiple' style={styles.icon} />
                <Text style={styles.text}>Forecast</Text>
            </Button>
        </Container>
